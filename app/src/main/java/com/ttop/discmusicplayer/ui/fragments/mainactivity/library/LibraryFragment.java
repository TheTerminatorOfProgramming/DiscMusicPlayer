package com.ttop.discmusicplayer.ui.fragments.mainactivity.library;
...
import com.ttop.discmusicplayer.adapter.MusicLibraryPagerAdapter;
import com.ttop.discmusicplayer.dialogs.CreatePlaylistDialog;
import com.ttop.discmusicplayer.helper.MusicPlayerRemote;
import com.ttop.discmusicplayer.helper.SortOrder;
import com.ttop.discmusicplayer.interfaces.CabHolder;
import com.ttop.discmusicplayer.loader.SongLoader;
import com.ttop.discmusicplayer.ui.activities.MainActivity;
import com.ttop.discmusicplayer.ui.activities.SearchActivity;
import com.ttop.discmusicplayer.ui.activities.SettingsActivity;
import com.ttop.discmusicplayer.ui.fragments.mainactivity.AbsMainActivityFragment;
import com.ttop.discmusicplayer.ui.fragments.mainactivity.library.pager.AbsLibraryPagerRecyclerViewCustomGridSizeFragment;
import com.ttop.discmusicplayer.ui.fragments.mainactivity.library.pager.AlbumsFragment;
import com.ttop.discmusicplayer.ui.fragments.mainactivity.library.pager.ArtistsFragment;
import com.ttop.discmusicplayer.ui.fragments.mainactivity.library.pager.PlaylistsFragment;
import com.ttop.discmusicplayer.ui.fragments.mainactivity.library.pager.SongsFragment;
...
public class LibraryFragment extends AbsMainActivityFragment implements CabHolder, MainActivity.MainActivityFragmentCallbacks, ViewPager.OnPageChangeListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (!prefs.contains("UI")) {
            mPref.setUI("New UI");
        }

        if (mPref.getUI().equalsIgnoreCase("Classic UI")) {
            view = inflater.inflate(R.layout.fragment_library, container, false);
        } else if (mPref.getUI().equalsIgnoreCase("New UI")) {
            view = inflater.inflate(R.layout.fragment_library_new, container, false);
        }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_settings:
                new Handler().postDelayed(() -> startActivity(new Intent(getActivity(), SettingsActivity.class)), 200);
                break;
        }
